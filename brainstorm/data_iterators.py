...
class Flip(DataIterator, Seedable):
    ...
    def __init__(self, iter, prob_dict=None, seed=None):
        ...
        Args:
            ...
            seed (Optional[int]):
                random seed to control the randomness of this iterator
        """
        Seedable.__init__(self, seed=seed)
        DataIterator.__init__(self, iter.data_shapes, iter.length)
...
class Undivided(DataIterator):
    ...
    def __init__(self, **named_data):
        ...
        DataIterator.__init__(self, data_shapes, 1)
...
class Online(DataIterator, Seedable):
    ...
    def __init__(self, shuffle=True, seed=None, **named_data):
        ...
        data_shapes = {n: v.shape for n, v in named_data.items()}
        DataIterator.__init__(self, data_shapes, nr_sequences)
        self.data = named_data
...
class Minibatches(DataIterator, Seedable):
    ...
    def __init__(self, batch_size, shuffle=True, seed=None, **named_data):
        """
        Args:
            **named_data (dict[str, np.ndarray]):
                named arrays with 3+ dimensions ('T', 'B', ...)
        ...
        DataIterator.__init__(self, data_shapes, nr_batches)
        self.data = named_data
        self.shuffle = shuffle
