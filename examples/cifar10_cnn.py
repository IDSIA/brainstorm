...
inp >> \
    bs.layers.Convolution2D(32, kernel_size=(5, 5), pad=2, name='conv1', activation_function='rel') >> \
    bs.layers.Pooling2D(32, window_size=(3, 3), stride=(2, 2), name='pool1') >> \
    bs.layers.Convolution2D(32, kernel_size=(5, 5), pad=2, name='conv2', activation_function='rel') >> \
    bs.layers.Pooling2D(32, window_size=(3, 3), stride=(2, 2), name='pool2') >> \
    bs.layers.Convolution2D(64, kernel_size=(5, 5), pad=2, name='conv3', activation_function='rel') >> \
    bs.layers.Pooling2D(64, window_size=(3, 3), stride=(2, 2), name='pool3') >> \
